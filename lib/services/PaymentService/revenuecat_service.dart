...
class RevenueCatService {
  ...
  /// Returns hardcoded euro price strings for add-on products.
  /// Android returns null so dialogs fall back to localisation strings.
  Future<({String? designPrice, String? techpackPrice})>
      fetchAddonPriceStrings() async {
    if (!Platform.isIOS) {
      return (designPrice: null, techpackPrice: null);
    }
    return (designPrice: '€9.99', techpackPrice: '€5.99');
  }
