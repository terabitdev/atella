...
//     if (isQuestionAnswered(questionId)) {
//       print(
//         'Updating already answered question immediately: $questionId',
//       );
...
//   void _confirmMultiSelection({bool shouldAdvance = true, String? forQuestionId}) {
...
//     collapseCategory(confirmedQuestionId);
...
//     // Store categories that were updated for collapsing
//     final updatedCategories = _tempCategorizedSelections.keys.toList();
...
//     // Collapse the categories that were updated
//     for (final categoryName in updatedCategories) {
