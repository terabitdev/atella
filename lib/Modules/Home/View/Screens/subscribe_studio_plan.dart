...
class SubscribeStudioPlan extends StatefulWidget {
  ...
  @override
  State<SubscribeStudioPlan> createState() => _SubscribeStudioPlanState();
}

class _SubscribeStudioPlanState extends State<SubscribeStudioPlan> {
                            ...
                            Obx(
                              () => Column(
                                children: [
                                  ...
                                  SizedBox(height: 16.h),
                                  _buildFeatureItem('Priority access'),
                                  SizedBox(height: 16.h),
                                  _buildFeatureItem('Full branding'),
                                  SizedBox(height: 16.h),
                                  _buildFeatureItem('Full exports'),
                                  SizedBox(height: 16.h),
                                  _buildFeatureItem('Factory access'),
                                  SizedBox(height: 16.h),
                                  _buildFeatureItem(
                    ...
                    Column(
                      children: [
                        Obx(() {
                          ...
                          // Check if user is on lower tier plans (for upgrade messaging)
                          bool isLowerTierUser =
                              currentPlan == 'STARTER' ||
                          ...
                          return Column(
                            children: [
                              ...
                              // Cancel subscription button for current STUDIO users
