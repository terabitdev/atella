...
class OnboardingProductionScreen extends StatefulWidget {
  ...
  @override
  State<OnboardingProductionScreen> createState() => _OnboardingProductionScreenState();
}

class _OnboardingProductionScreenState extends State<OnboardingProductionScreen> {
  int _selectedIndex = -1;

  List<String> _options(AppLocalizations l10n) => [
    l10n.onboardingProductionOption1,
    l10n.onboardingProductionOption2,
    l10n.onboardingProductionOption3,
    l10n.onboardingProductionOption4,
  ];
                  ...
                  Expanded(
                    child: _FilledButton(
                      ...
                      onTap: () async {
                        ...
                        await OnboardingStorageService().saveProduction(options[_selectedIndex]);
                        Get.toNamed(AppRoutes.onboardingDiscovery);
                      },
                    ),
                  ),
                ],
